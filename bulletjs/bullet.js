/*
 * bullet.js (c) 2013 Peter Lueders <pl@jzone.de>
              ...
              var frictionIndex = this.tmpSolverConstraintPool.length;
              {
                ...
                if (!cp.lateralFrictionInitialized) {
                  ...
                  if (lat_rel_vel > Bullet.BulletGlobals.FLT_EPSILON)  {
                    cp.lateralFrictionDir1.scale1(1 / Math.sqrt(lat_rel_vel));
                    ...
                    cp.lateralFrictionDir2.normalize0(); //??
...
//fr o,28,767
//fr p,41,1423
//fr x,compile.cmd,copyto D:/tools/Dropbox/Public/bulletjs
