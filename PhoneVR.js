...
PhoneVR.prototype.rotationQuat = function() {
    ...
    var deviceQuaternion=new Vecmath.Quat4(x,y,z,w);//quat.fromValues(x, y, z, w);

    // Correct for the screen orientation.
    var screenOrientation=(this.getScreenOrientation() * degtorad)/2;
    var screenTransform=new Vecmath.Quat4(0,0,-Math.sin(screenOrientation),Math.cos(screenOrientation));

    var deviceRotation=new Vecmath.Quat4();//quat.create();
    deviceRotation.mul2(deviceQuaternion,screenTransform);
    ...
    deviceRotation.mul2(new Vecmath.Quat4(-r22, 0, 0, r22),deviceRotation);

    //var formattedOrientation = {};
    //formattedOrientation.x = deviceRotation.x;
    //formattedOrientation.y = deviceRotation.y;
    //formattedOrientation.z = deviceRotation.z;
    //formattedOrientation.w = deviceRotation.w;
    return deviceRotation;//formattedOrientation;
}
