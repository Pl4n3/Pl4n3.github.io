...
(function() {
  ...
  window.w3ditScriptInit(function (ps) {
    ...
    Conet.download({fn:'/canvas/deep/deep7.txt',f:function(v) {
      //---
      let du=deep.dungeonLoad(JSON.parse('['+v+']'));
      //onsole.log(du);
      ...
      let dum0=new THREE.Mesh(new THREE.BoxGeometry(0.1,0.1,0.1),m1);ps.mesh.add(dum0);
      let dum1=new THREE.Mesh(new THREE.BoxGeometry(0.1,0.1,0.1),m2);ps.mesh.add(dum1);
